...
#define SL_SPIDRV_INST_PERIPHERAL	USARTRF1
#define SL_SPIDRV_INST_ROUTE_LOC	5

#define SL_SPIDRV_INST_TX_PORT		gpioPortC
#define SL_SPIDRV_INST_TX_PIN		1

#define SL_SPIDRV_INST_RX_PORT		gpioPortC
#define SL_SPIDRV_INST_RX_PIN		2

#define SL_SPIDRV_INST_CLK_PORT		gpioPortC
#define SL_SPIDRV_INST_CLK_PIN		3

#define SL_SPIDRV_INST_CS_PORT		gpioPortC
#define SL_SPIDRV_INST_CS_PIN		0
